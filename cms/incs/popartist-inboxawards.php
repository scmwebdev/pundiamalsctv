<?
	...
	$bauth 		= new Auth();
	require_once MOD_DIR.'inboxawards-artistnominees.lib.php';
    $bcms 		= new artistnominees();
...
<body bgcolor="#99CC99" link="#0000FF" vlink="#0000FF" alink="#FF0000">
    ...
    <fieldset class="tbl_font"><legend class="tbl_font"><b>Inbox Music Artist</b> Explorer</legend>
	...
	$data 		= $bcms->selectDataPopArtistInboxawards($id,$keysearch,$fldsearch,$ktgsearch,$_page);
    $totRec 	= $bcms->totRec;
	...
	$pagging 	= getPagging($makeUrl,$_page,$totRec,REC_PER_PAGE);
    ?>
    <strong>Page:</strong> <?=$pagging?><br />
    <table width="100%" border="0" cellpadding="1" cellspacing="2" >
    <tr>
        <td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>Artist ID</strong></td>
        <td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>Thumbnail</strong></td>
        <td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>Artist Name</strong></td>
    ...
    foreach($data as $k => $v){
            ...
            echo "<td class='tbl_font' align='center'><strong>[".$v["artist_id"]."]</strong></td>";
            echo "<td class='tbl_font' width='70px'><img width='70' height='40' src=".($bcms->getThumbnail($v["tpic_id"])?MEDIA_LIPUTAN6.$bcms->getThumbnail($v["tpic_id"]):TPL_URL."webadmin/images/noimage.jpg")."></td>";
            echo "<td class='tbl_font'>".$v["artist_name"]."</td>";
            echo "<td class='tbl_font' style='text-align:center'>";
            echo " [<a href=\"javascript:sendStr('".$v["artist_id"]."','".$_GET["idField"]."','".$_GET["idFrm"]."')\"><span style='color:#0000FF; font-weight:bold'>Pick</span></a>]";
            echo "</td></tr>";
    }
    ?>
    </table>
