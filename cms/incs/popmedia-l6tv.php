...
<body bgcolor="#99CC99" link="#0000FF" vlink="#0000FF" alink="#FF0000">
    ...
    <fieldset class="tbl_font"><legend class="tbl_font">Pop Up <b>Media For Video</b> Explorer</legend>
    ...
    */?>
    ...
    $data 		= $bcms->getListDataMedia($c_id,$tgl,0,$keysearch,$fldsearch,$_page);
    $totRec 	= $bcms->totRec;
    ...
    <tr>
        ...
        <td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>Date</strong></td>
