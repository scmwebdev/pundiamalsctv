...
<?
require_once MOD_DIR.'pundiamal-media.lib.php';
$bcms = new PAMedia();
$field = $bcms->getField();
?>
...
foreach($data as $k => $v){
	...
	if($v["type"] == "vidID")
		echo " [<a href='".FILES_PUNDIAMAL.$v["location"]."'>video</a>] ";
	elseif($v["type"] == "audID")
		echo " [<a href='".FILES_PUNDIAMAL.$v["location"]."'>audio</a>] ";
	elseif($v["type"] == "mvidID")
		echo " [<a href='".FILES_PUNDIAMAL.$v["location"]."'>mobile video</a>] ";
	else
		echo " <img src='".FILES_PUNDIAMAL.$v["location"]."' width='57' /> ";
		echo "</td>";
