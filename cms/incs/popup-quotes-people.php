<?php
    ...
    require_once MOD_DIR.'bola/bola-quotes-people.lib.php';
    $bcms      = new LBolaQuotesPeople();
    ...
    <tr>
        <td class="tbl_font">
            <fieldset class="tbl_font">
                <legend class="tbl_font">Pop Up <b>People Quotes</b> Explorer</legend>
                ...
                <table width="100%" border="0" cellpadding="1" cellspacing="2" >
                    <tr>
                        <td align="center" class='tbl_font' bgcolor="#CCCCCC" style="width: 70px"><strong>Thumb</strong></td>
                        <td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>People Name</strong></td>
                    ...
                    foreach($data as $k => $v){
                            ...
                            echo "<td class='tbl_font' align='center'><img src='".$v['tpic_url']."' width='60px'></td>";
                            echo "<td class='tbl_font'>".$v["people_name"]."</td>";
                            echo "<td class='tbl_font' style='text-align:center'>";
                            echo " [<a href=\"javascript:sendStr('".$v["id"]."','".$v["people_name"]."','".$_GET["idField"]."','".$_GET["idField2"]."','".$_GET["idFrm"]."')\"><span style='color:#0000FF; font-weight:bold'>Pick</span></a>]";
                            echo "</td></tr>";
                    } ?>
                </table>
