...
<body link="#0000FF" vlink="#0000FF" alink="#FF0000">
	<? if(!$bauth->checkSession() && URIGHT): ?>
		...
		<tr>
			<td class="tbl_font">
				<fieldset class="tbl_font"><legend class="tbl_font">Pop Up Member Users of Citizen6</legend>
					...
					$data = $bcms->getListData($id,$keysearch,$fldsearch,$_page);
					$totRec = $bcms->totRec;
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="2" >
						<tr>
							...
							<td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>Last Name</strong></td>
						...
						foreach($data as $k => $v){
							...
							echo $v["id_member"];
							echo "</td>";
							echo "<td class='tbl_font'>".$v["fname"]."</td>";
							echo "<td class='tbl_font'>".$v["lname"]."</td>";		
							echo "<td class='tbl_font'>".$v["email"]."</td>";		
							echo "<td class='tbl_font' style='text-align:center'>";
							echo " [<a href=\"javascript:sendStr('".$v["email"]."','".$_GET["idField"]."','".$_GET["idFrm"]."')\"><span style='color:#0000FF; font-weight:bold'>Pick</span></a>]";
							echo "</td></tr>";
						}
						?>
					</table>
