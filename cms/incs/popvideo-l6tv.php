...
<body bgcolor="#99CC99" link="#0000FF" vlink="#0000FF" alink="#FF0000">
    ...
    <fieldset class="tbl_font"><legend class="tbl_font">Pop Up <b>Video File For Video</b> Explorer</legend>
        ...
        <table width="100%" border="0">
            ...
            <tr>
                ...
                <td class="tbl_font">: 
                    ...
                    <input type="submit" name="submit" class="form_button" value="Display">
    ...
    $data        = $bcms->getListDataVideo($c_id,$tgl,0,(isset($keysearch)?$keysearch:""),(isset($fldsearch)?$fldsearch:""),$_page);
    $totRec      = $bcms->totRec;
    $makeUrl     = $_SERVER['PHP_SELF']."?tanggal=".$tgl."&kategori=".$c_id."&idFrm=".(isset($_GET["idFrm"])?$_GET["idFrm"]:"")."&idField=".(isset($_GET["idField"])?$_GET["idField"]:"")."&idField2=".(isset($_GET["idField2"])?$_GET["idField2"]:"")."&mod=".$_GET["mod"]."&keysearch=".(isset($keysearch)?$keysearch:"")."&fldsearch=".(isset($fldsearch)?$fldsearch:"");
    ...
    <tr>
        ...
        <td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>Timestamp</strong></td>
    ...
    foreach($data as $k => $v){
            ...
            echo "<td class='tbl_font' align='center'><strong>[<a href=".MEDIA_LIPUTAN6.$v['location'].">".$v["id"]."</a>]</strong></td>";
            ...
            echo "<td class='tbl_font'>".$v["timestamp"]."</td>";
