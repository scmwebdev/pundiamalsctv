...
<? if(!$bauth->checkSession() && URIGHT):
    ...
    $twitter_channel = (isset($_REQUEST['ch']) && $_REQUEST['ch'] == 'yes') ?  'yes' : 'no';
...
/* Parameters for bt.ly */
    ...
    switch ($cha_id) {
        case 10: // tekno
            $twitter_site   = '@Lip6Tekno';
            break;
             
        case 9: // health
            $twitter_site   = '@Lip6Health';
            break;
             
        case 5: // showbiz
            $twitter_site   = '@Lip6Showbiz';
            break;
             
        case 7: // bola / sports
            $twitter_site   = '@Lip6Sport';
            break;
            
        case 14: // bisnis
            $twitter_site   = '@Lip6Bisnis';
            break;
            
        default:
            $twitter_site   = ($cat_id == '171') ? '@citizen6_' : '@liputan6dotcom';
    }
    
    if ($twitter_channel == 'no') $twitter_site   = '@liputan6dotcom';
?>
...
<h2>Tweet News to Twitter</h2>

<!--form id="myForm" name="myForm" method="post" action="index.php?mod=<?=$_REQUEST['mod']?>" onSubmit="return dataValidation()"-->

<form id="myForm" name="myForm" method="post" action="index.php?mod=<?=$_REQUEST['mod']?>">
<input type="hidden" name="cat_id" value="<?=$cat_id?>" />
<input type="hidden" name="cha_id" value="<?=$cha_id?>" />
<input type="hidden" name="twitter_channel" value="<?=$twitter_channel?>" />
<table>
<tr class="out" onmouseover='this.className="over"' onmouseout='this.className="out"'>
    <td nowrap="nowrap" class="content" valign="top">Tweet To :</td>
    <td class="content"><b><?=$twitter_site?></b></td>
</tr>
<tr class="out" onmouseover='this.className="over"' onmouseout='this.className="out"'>
    <td nowrap="nowrap" class="content" valign="top">Tweet :</td>
    <td class="content"><textarea name="title_to_twitter" style="width:100%" rows="5" cols="60"><?=$title?></textarea></td>
</tr>
