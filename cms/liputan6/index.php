...
//$tpl->config['WebtorialType'] = 'hhaha'; $config['WebtorialType'];
...
if(!empty($_SESSION['login'])){
  ...
  // admin list all
    if($_SESSION["login"] == "admin"){
        ...
        if (!defined('UGROUP')) define("UGROUP", 1);
    } else {
        ...
        if (!defined('UGROUP')) define("UGROUP", $bauth->ugId);
    }

    $bmod->disconnect();

    $tpl->display('l6-main.tpl.php');
