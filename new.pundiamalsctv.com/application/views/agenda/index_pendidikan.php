    ...
    <div id="content" class="fl">
    	<div id="insidepage-container" class="fl">
             ...
             <div id="title-insidepage">
             	<div class="judul">Indeks Pendidikan</div>
          </div>
             <div id="insidepage-content">
				...
				echo $pilar[0]['shortdesc'];?></p>
                  <ul>
                  <?php foreach($detail_pilar_pendidikan as $v => $k): ?>
                  <li><?php if(!empty($k['location'])) {?><img src="http://static.pundiamalsctv.com<?php echo($k['location']);?>" width="144" height="81" class="fl mr6"><?php }else{?><img src="<?php echo site_url();?>images/pundi-amal.jpg" width="144" height="81" class="fl mr6"><?php } ?>
                 <span style="color:#777777"><?php $tanggal=date("d-m-Y", strtotime($k['dates']));
				echo $tanggal;?></span><br>
                <?php
				  $slug = url_title($k['title'], 'dash', true);
				  //print_r($slug);
				?>
                    <a href="<?php echo base_url('index.php/agenda/view/'.$k['id'].'/'.$slug); ?>"><?php echo $k['title'];?> </a></li>
                    
                    <?php endforeach; ?>
                  </ul>
                 <ul id="paging" class="fr">
            <li style="border-bottom:none;"><?php echo $this->pagination->create_links();?></li><li style="border-bottom:none;"></li></ul>
          </div>
