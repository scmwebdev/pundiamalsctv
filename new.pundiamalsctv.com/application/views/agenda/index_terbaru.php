    ...
    <div id="content" class="fl">
        ...
        <div id="title-insidepage">
             	<div class="judul">Indeks Terbaru</div>
          </div>
    	    <div id="insidepage-content">
               	<div id="insidepage-inside">
               	    <ul>
                    <?php foreach($detail_terbaru as $k=>$v):?>
...
<div class="selengkapnya" style="padding-right:10px;"><a href="<?php echo base_url();?>index.php/penyumbang/index">Selengkapnya</a></div><br><br>
      ...
      <div id="title-yellow">
        ...
        <div id="left-content-inside1"><img src="<?php echo base_url().'images/'.substr($v['location'],1);?>" width="218" height="124"></a>
               <?php
				  $slug = url_title($v['title'], 'dash', true);
				  //print_r($slug);
				?>
      ...
      <div id="title-yellow">
			...
			<?php if(empty($v['loc_tpic'])){?>
             ...
             <?php } ?>
              <?php echo ucfirst(strtolower($v['title']));?> </div>
               <div class="horizontal1"></div>
               <?php endforeach; ?>
