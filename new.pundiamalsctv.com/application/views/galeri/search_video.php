             ...
             <div id="insidepage-content">
				...
				?>
                  ...
                  <?php foreach($search as $v => $k): ?>
                   <li><?php if(!empty($k['location'])) {?><img src="<?php echo base_url().'images/'.substr($k['location'],1);?>" width="144" height="81" class="fl mr6"><?php }else{?><img src="<?php echo site_url();?>images/pundi-amal.jpg" width="144" height="81" class="fl mr6"><?php } ?><span style="color:#77777"><?php $tanggal=date("d-m-Y", strtotime($k['dates']));
...
<div class="selengkapnya mr30"><a href="<?php echo base_url();?>index.php/penyumbang/index">Selengkapnya</a></div><br><br>
      ...
      <li><span style="color:#77777"><img src="<?php echo base_url().'images/'.substr($v['location'],1);?>" width="144" height="81" class="fl mr6"><?php $tanggal=date("d-m-Y", strtotime($k['dates']));
				echo $tanggal;?></span>
        <br>
        <?php
