		    ...
		    <?php foreach($calender as $k=>$v):?>
				{
					...
					//description:<?php echo ucfirst(strtolower($v['judul']));?>,
					url: '<?php 
...
<div id="wrapper">
  <div id="container">
    <div id="top">
         ...
         <form method="get" action="<?php echo base_url();?>index.php/home/search" id="search" style="width:200px; float:left; margin-left:400px; margin-top:55px">
   ...
   <div id="logo-sctv" class="fr" style="padding-top:16px; padding-right:10px"><a href="http://www.sctv.co.id" target="_blank"><img src="<?php echo base_url();?>images/logo-sctv.png"></a></div>
    ...
    <div id="header">
        ...
        <div class="slider-wrapper theme-default">
            ...
            <a href=""><img src="http://pundiamalsctv.com/images/<?php echo $v['location'];?>" title="<?php echo $v['caption'];?>"/></a>   
            <?php endforeach;?>   
            <?php } ?> 
            </div>
        </div>
