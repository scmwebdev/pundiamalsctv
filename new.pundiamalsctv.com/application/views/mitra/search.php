    	...
    	<div id="insidepage-container" class="fl">
             ...
             <div id="insidepage-content">
                ...
                <?php
				  ...
				  //print_r($slug);
				?>
                <b> <a href="<?php echo base_url('index.php/mitra/view/'.$k['id'].'/'.$slug); ?>"><?php echo ucfirst(strtolower($k['title']));?></a></b>
                    <br>
...
<table width="250" border="0" cellspacing="0" cellpadding="0">
 ...
 <div class="selengkapnya mr30"><a href="<?php echo base_url();?>index.php/penyumbang/index">Selengkapnya</a></div><br><br>
      ...
      <li><span style="color:#777777"><img src="http://static.pundiamalsctv.com<?php echo($v['location']);?>" width="144" height="81" class="fl mr6"><?php $tanggal=date("d-m-Y", strtotime($k['dates']));
				echo $tanggal;?></span>
        <br>
        <?php
				  ...
				  //print_r($slug);
				?>
        <a href="<?php echo base_url('index.php/mitra/view/'.$v['id'].'/'.$slug); ?>"><?php echo ucfirst(strtolower($v['title']));?>. </a></li>  
       <?php endforeach; ?>
      </ul>
