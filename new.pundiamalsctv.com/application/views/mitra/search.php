...
<table width="250" border="0" cellspacing="0" cellpadding="0">
 ...
 <div class="selengkapnya mr30"><a href="<?php echo base_url();?>index.php/penyumbang/index">Selengkapnya</a></div><br><br>
      ...
      <li><span style="color:#777777"><img src="<?php echo base_url().'images/'.substr($v['location'],1);?>" width="144" height="81" class="fl mr6"><?php $tanggal=date("d-m-Y", strtotime($k['dates']));
				echo $tanggal;?></span>
        <br>
        <?php
