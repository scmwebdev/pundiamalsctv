...
<span style="float:right"><a href="<?php echo base_url();?>index.php/penyumbang/index">Selengkapnya</a></span><br><br>
      ...
      <li><span style="color:#3300FF"><img src="<?php echo base_url().'images/'.substr($v['location'],1);?>" width="144" height="81" class="fl mr6"><?php $tanggal=date("d-m-Y", strtotime($k['dates']));
				echo $tanggal;?></span>
        <br>
        <?php
