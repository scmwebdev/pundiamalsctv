    	...
    	<div id="insidepage-container" class="fl">
             ...
             <div id="insidepage-content">
                ...
                <?php
				  ...
				  //print_r($slug);
				?>
                <b> <a href="<?php echo base_url('index.php/agenda/view/'.$k['id'].'/'.$slug); ?>"><?php echo ucfirst(strtolower($k['title']));?></a></b>
                    <br>
...
<span style="float:right"><a href="<?php echo base_url();?>index.php/penyumbang/index">Selengkapnya</a></span><br><br>
      ...
      <li><span style="color:#3300FF"><img src="http://static.pundiamalsctv.com<?php echo($v['location']);?>" width="144" height="81" class="fl mr6"><?php $tanggal=date("d-m-Y", strtotime($k['dates']));
				echo $tanggal;?></span>
        <br>
        <?php
      ...
      <span style="float:left; margin-left:145px;"><a href="<?php echo base_url();?>index.php/agenda/index_berita">Selengkapnya</a></span><br><br>
