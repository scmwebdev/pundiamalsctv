    ...
    <div id="content" class="fl">
    	<div id="insidepage-container" class="fl">
             ...
             <div id="insidepage-content">
               ...
               <p><img src="<?php echo base_url();?>images/kesehatan.jpg" width="700" height="300"><br>
			<?php //echo $testimoni[0]['shortdesc'];?></p>
				  ...
				  //print_r($slug);
				?>
                    <a href="<?php echo base_url('index.php/testimoni/view/'.$k['id'].'/'.$slug); ?>"><?php echo $k['title'];?></a></li>
                  <?php endforeach; ?> 
				<br></ul>
