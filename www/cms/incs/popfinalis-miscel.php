...
<?
require_once MOD_DIR.'eventsctv-misscelebrity.lib.php';
$bcms = new MissCell();
$field = $bcms->getFinalisField();
?>
...
$data = $bcms->listFinalis(2009,0,$keysearch,$fldsearch,$_page);
$totRec = $bcms->totRec;
...
<tr>
	...
	<td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>Tahun</strong></td>
	<td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>Nama</strong></td>
	<td align="center" class='tbl_font' bgcolor="#CCCCCC"><strong>Shortdesc</strong></td>
...
foreach($data as $v){
	...
	if($ii % 2 == 0) 
		...
		echo "<tr class='out2' onmouseover=\"this.className = 'over';\" onmouseout=\"this.className = 'out2';\">";
			echo "<td class='tbl_font' >".$v['id_finalis']."</td>";
			echo "<td class='tbl_font' >".$v["tahun"]."</td>";
			echo "<td class='tbl_font' >".$v["nama"]."</td>";
			echo "<td class='tbl_font' >".$v["shortdesc"]."</td>";
			echo "<td class='tbl_font' style='text-align:center'>";
			echo " [<a href=\"javascript:sendStr('".$v["id_finalis"]."','".$_GET["idField"]."','".$_GET["idFrm"]."')\"><span style='color:#0000FF; font-weight:bold'>Pick</span></a>]";
			echo "</td>";
	echo "</tr>";
}
?>
