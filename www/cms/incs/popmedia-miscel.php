...
$data = $bcms->listMedia(0,$keysearch,$fldsearch,$_page);
$totRec = $bcms->totRec;
...
<?
$arrType = array('picID' => 'Picture', 'tpicID' => 'Thumb', 'audID' => 'Audio', 'vidID' => 'Video', 'mpicID' => 'Mobile Pic.', 'mvidID' => 'Mobile Video');
$ii=0;
foreach($data as $k => $v){
		$ii++;
	...
	if($v["type"] == "vidID")
		echo " [<a href='".FILES_LIPUTAN6.$v["location"]."'>video</a>] ";
	elseif($v["type"] == "audID")
		echo " [<a href='".FILES_LIPUTAN6.$v["location"]."'>audio</a>] ";
	elseif($v["type"] == "mvidID")
		echo " [<a href='".FILES_LIPUTAN6.$v["location"]."'>mobile video</a>] ";
	else
		echo " <img src='".FILES_LIPUTAN6.$v["location"]."' width='57' /> ";
		echo "</td>";
		...
		echo " [<a href=\"javascript:sendStr('".$v["id_media"]."','".$_GET["idField"]."','".$_GET["idFrm"]."')\"><span style='color:#0000FF; font-weight:bold'>Pick</span></a>]";
		echo "</td></tr>";
}
?>
</table>
