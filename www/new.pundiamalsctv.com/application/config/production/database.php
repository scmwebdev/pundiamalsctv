...
$db['DB_WRITE']['hostname'] = "192.168.7.20";
$db['DB_WRITE']['username'] = "makichan";
$db['DB_WRITE']['password'] = "r8n2XKiBf";
$db['DB_WRITE']['database'] = 'pundiamalsctv_www';
$db['DB_WRITE']['dbdriver'] = 'mysql';
$db['DB_WRITE']['dbprefix'] = '';
$db['DB_WRITE']['pconnect'] = TRUE;
$db['DB_WRITE']['db_debug'] = FALSE;
...
$db['DB_READ']['hostname'] = "192.168.7.20";
$db['DB_READ']['username'] = "makichan";
$db['DB_READ']['password'] = "r8n2XKiBf";
$db['DB_READ']['database'] = "intra_humas";
$db['DB_READ']['dbdriver'] = "mysql";
$db['DB_READ']['dbprefix'] = "";
$db['DB_READ']['pconnect'] = FALSE;
$db['DB_READ']['db_debug'] = FALSE;
