...
class Testimoni extends CI_Controller
{
	...
	function index()
	{
		...
		$jumlah=$this->homepage_model->count_testimoni();	
		$total = count($jumlah);
		
		$config['base_url'] 		= base_url().'index.php/testimoni/testimoni/';
		...
		$data['data_testimoni']		  = $this->homepage_model->all_testimoni($config['per_page'],$page);
		...
		$this->load->view('testimoni/footer',$data);
	}
	...
	function search()
	{
	 ...
	 //  print_r($keyword);
		...
		$total = count($jumlah);
		$config['base_url'] 		= base_url().'index.php/testimoni/search/';
		$config['total_rows'] 		= $total;
		$config['per_page'] 		= 7;
		$config['num_links'] 		= 10;
		...
		$this->load->view('testimoni/header',$data);
		$this->load->view('testimoni/search', $data);	
		$this->load->view('testimoni/footer',$data);
	}
	...
	function view()
	{
		...
		$this->load->view('testimoni/header',$data);
		$this->load->view('testimoni/read', $data);	
		$this->load->view('testimoni/footer',$data);
	}
