...
<span style="float:right"><a href="<?php echo base_url();?>index.php/penyumbang/index">Selengkapnya</a></span><br><br>
      ...
      <li><span style="color:#77777"><img src="http://static.pundiamalsctv.com<?php echo($v['location']);?>" width="144" height="81" class="fl mr6"><?php $tanggal=date("d-m-Y", strtotime($v['dates']));
				echo $tanggal;?></span>
        <br>
