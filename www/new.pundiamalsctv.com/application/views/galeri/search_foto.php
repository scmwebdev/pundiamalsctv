    ...
    <div id="content" class="fl">
    	<div id="insidepage-container" class="fl">
             ...
             <div id="title-insidepage">
             	<div class="judul">Pundi Amal SCTV : Kumpulan Gallery <?php echo $keyword;?> >>></div>
          </div>
             <div id="insidepage-content">
                ...
                <?php
				  ...
				  //print_r($slug);
				?>
                <b> <a href="<?php echo base_url('index.php/galeri/view_foto/'.$k['id'].'/'.$slug); ?>"><?php echo ucfirst(strtolower($k['title']));?></a></b>
                    </li>
...
<div class="selengkapnya mr30"><a href="<?php echo base_url();?>index.php/penyumbang/index">Selengkapnya</a></div><br><br>
      ...
      <li><span style="color:#7777"><img src="http://static.pundiamalsctv.com<?php echo($v['location']);?>" width="144" height="81" class="fl mr6"><?php $tanggal=date("d-m-Y", strtotime($v['dates']));
				echo $tanggal;?></span>
        <br>
        <?php
     ...
     <div class="selengkapnya mr30"><a href="<?php echo base_url();?>index.php/agenda/index_berita">Selengkapnya</a></div><br><br>
      ...
      <li><span style="color:#777"><?php $tanggal=date("d-m-Y", strtotime($v['dates']));
	  echo $tanggal;
	  ?></span>
        <br>
        <?php
