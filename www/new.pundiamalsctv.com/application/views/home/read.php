   ...
   <div id="content" class="fl">
    	<div id="insidepage-container" class="fl">
    	    <div id="insidepage-content">
                 ...
                 <p>
				 <?php if(!empty($ambilisi[0]['location'])) {?><img src="http://static.pundiamalsctv.com<?php echo $ambilisi[0]['location'];?>" width="700" height="300"><?php }else{?><img src="<?php echo site_url();?>images/pundi-amal.jpg" width="700" height="300"><?php } ?><br>
      ...
      <ul>
       ...
       <li><span style="color:#777777"><?php $tanggal=date("d-m-Y", strtotime($v['dates']));
        ...
        <?php
				  ...
				  //print_r($slug);
				?>
        <a href="<?php echo base_url('index.php/home/view/'.$v['id'].'/'.$slug); ?>"><?php echo ucfirst(strtolower($v['title']));?>. </a></li>  
       <?php endforeach; ?> 
      </ul>
