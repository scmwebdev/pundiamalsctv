    ...
    <div id="content" class="fl">
    	<div id="insidepage-container" class="fl">
             ...
             <div id="search-right">  <form id="searchForm" name="searchForm" method="get" action="<?php echo base_url();?>index.php/penyumbang/cari_penyumbang">
...
<option value="nama">Nama</option><option value="tanggal">Tanggal</option><option value="kota">Kota</option></select>
</td>
<td><input name="spotlight" type="image" id="spotlight" src="<?php echo base_url();?>images/search.png" /></td>
 ...
 <table width="700" border="0" cellspacing="0" cellpadding="0">			 
  <tr>
	...
	<td width="223" height="30px" bgcolor="#9c9c9c"><div align="center"><strong>Tanggal</strong></div></td>
  ...
  <tr>
    <td valign="top" bgcolor="#9c9c9c"><table width="700" border="0" cellspacing="1" cellpadding="4">
      <?php $nourut =$page; $counter = 1;?>
		<?php 
		if (is_array($datapenyumbang))
		{
		foreach($datapenyumbang as $k => $v ):?>
        <?php $nourut++; ?>
        <?php
        ...
        ?>
          <tr>
           ...
           <td width="39" align="center" bgcolor="<?php echo $warna;?>"><?php echo $nourut;?></td>
            ...
            <td width="223" bgcolor="<?php echo $warna;?>"><?php echo ucfirst(strtolower($v['kota']));?></td>
			<td width="223" bgcolor="<?php echo $warna;?>"><?php echo ucfirst(strtolower($v['tanggal']));?></td>
            <td width="167" bgcolor="<?php echo $warna;?>" align="right"><?php echo number_format($v['jumlah'],2,",",".") ;?></td>
          </tr>
          <?php $counter++; ?>
          <?php endforeach;
		  }
