  ...
  <div id="container">
    <div id="top">
   	  <div id="logo" class="fl"><a href="<?php echo base_url();?>index.php/home/index"><img src="<?php echo base_url();?>images/logo_pundiamal.png"></a></div>
           <form method="get" action="<?php echo base_url();?>index.php/penyumbang/search" id="search" style="width:200px; float:left; margin-left:400px; margin-top:55px">
          ...
          <div id="menu" class="fl">
             ...
             <ul>
               ...
               <li><a href="<?php echo base_url();?>index.php/profil/index">PROFIL</a></li>
                ...
                <li><a class="current" href="<?php echo base_url();?>index.php/penyumbang/index">DAFTAR PENYUMBANG</a></li>
    ...
    <div id="header">
        ...
        <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
                <a href="http://www.yahoo.com"><img src="<?php echo base_url();?>images/slide1.jpg" title="Memberikan Layanan Kesehatan Gratis" /></a>
               <a href="http://www.yahoo.com"> <img src="<?php echo base_url();?>images/slide2.jpg" title="Membantu Pengembangan Pendidikan Karakter" /></a>
                <a href="http://www.yahoo.com"><img src="<?php echo base_url();?>images/slide3.jpg" title="This is an example of a caption" /></a>
               <a href="http://www.yahoo.com"> <img src="<?php echo base_url();?>images/slide4.jpg" title="This is an example of a caption" /></a>
    ...
    <div id="socmed" class="fr"><a href="http://www.facebook.com/pages/Pundi-Amal-SCTV/465055126923601"><img src="<?php echo base_url();?>images/fb.png"></a><a href="https://twitter.com/pundiamalsctv"><img src="<?php echo base_url();?>images/twitter.png" width="41" height="41"></a><a href="https://www.youtube.com/channel/UC3-aoGEDPP0D5kOcs-_vMGg/videos
"><img src="<?php echo base_url();?>images/youtube.png" width="41" height="41"></a></div>