...
?>
    ...
    <div id="content" class="fl">
         ...
         <div class="baca-juga" style="margin-top: 0px;">
            ...
            <ul>
                ...
                <?php
				  ...
				  //print_r($slug);
				?>
                  <a href="<?php echo base_url('index.php/profil/view/'.$v['id'].'/'.$slug); ?>"><?php echo ucwords($v['title']);?>
                  </a></li>
                  <?php endforeach;?>
      ...
      <li><span style="color:#777777"><?php $tanggal=date("d-m-Y", strtotime($v['dates']));
       ...
       <span style="float:right; padding-right:10px" class="selengkapnya"><a href="<?php echo base_url();?>index.php/agenda/index_terbaru">Selengkapnya</a></span><br><br />
      </div>
      ...
      <?php endforeach;?>
       ...
       <span style="float:right; padding-right:10px" class="selengkapnya"><a href="<?php echo base_url();?>index.php/agenda/info_kegiatan">Selengkapnya</a></span><br><br />
      </div>
        </div>
    <div class="cb"></div>
    </div>
