    	...
    	<div id="insidepage-container" class="fl">
    	    <div id="insidepage-content">
                 ...
                 <p><?php if(!empty($ambilisi[0]['location'])) {?><img src="http://static.pundiamalsctv.com<?php echo $ambilisi[0]['location'];?>" width="700" height="300"><?php }else{?><img src="<?php echo site_url();?>images/pundi-amal.jpg" width="700" height="300"><?php } ?><br>
					...
					<div><a href="#"  onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(location.href), 'facebook-share-dialog', 'width=626,height=436'); return false;"><img src="<?php echo base_url();?>images/Share.png" alt="share"></a>
					<script>
					!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");
					</script>
					
					<div class="wdt"><a href="https://twitter.com/share" class="twitter-share-button" data-via="pundiamalsctv" data-lang="en">Tweet</a></div></div>
         ...
         <div class="baca-juga" style="margin-top: 0px;">
            ...
            <ul>
                ...
                <?php
				  ...
				  //print_r($slug);
				?>
                  <a href="<?php echo base_url('index.php/testimoni/view/'.$v['id'].'/'.$slug); ?>"><?php echo ucwords($v['title']);?>
                  </a></li>
                  <?php endforeach;?>
